...
__export(index_exports, {
  ...
  ComposioToolVersionRequiredError: () => ComposioToolVersionRequiredError,
  ...
  ToolRouterConfigSchema: () => ToolRouterConfigSchema,
  ToolRouterSessionSchema: () => ToolRouterSessionSchema,
  ToolRouterToolkitConfigSchema: () => ToolRouterToolkitConfigSchema,
  ...
  handleToolExecutionError: () => handleToolExecutionError,
...
// src/composio.ts
var import_client8 = __toESM(require("@composio/client"), 1);
...
var AuthConfigCreationToolAccessConfigSchema = import_v3.z.object({
  toolsForConnectedAccountCreation: import_v3.z.array(import_v3.z.string()).optional()
});
var AuthConfigToolAccessConfigSchema = import_v3.z.object({
  toolsAvailableForExecution: import_v3.z.array(import_v3.z.string()).optional(),
  toolsForConnectedAccountCreation: import_v3.z.array(import_v3.z.string()).optional()
});
var AuthSchemeEnum = import_v3.z.enum([
  "OAUTH2",
  "OAUTH1",
  "API_KEY",
  "BASIC",
...
var CreateCustomAuthConfigParamsSchema = import_v3.z.object({
  type: import_v3.z.literal("use_custom_auth"),
  name: import_v3.z.string().optional(),
  credentials: import_v3.z.record(import_v3.z.string(), import_v3.z.union([import_v3.z.string(), import_v3.z.number(), import_v3.z.boolean()])),
  authScheme: AuthSchemeEnum,
  proxyConfig: import_v3.z.object({
    proxyUrl: import_v3.z.string(),
    proxyAuthKey: import_v3.z.string().optional()
  }).optional(),
  toolAccessConfig: AuthConfigCreationToolAccessConfigSchema.optional()
});
var CreateComposioManagedAuthConfigParamsSchema = import_v3.z.object({
  type: import_v3.z.literal("use_composio_managed_auth"),
  name: import_v3.z.string().optional(),
  credentials: import_v3.z.record(import_v3.z.string(), import_v3.z.union([import_v3.z.string(), import_v3.z.number(), import_v3.z.boolean()])).optional(),
  toolAccessConfig: AuthConfigCreationToolAccessConfigSchema.optional()
});
var CreateAuthConfigParamsSchema = import_v3.z.discriminatedUnion("type", [
  CreateCustomAuthConfigParamsSchema,
  CreateComposioManagedAuthConfigParamsSchema
]);
var CreateAuthConfigResponseSchema = import_v3.z.object({
  id: import_v3.z.string(),
  authScheme: import_v3.z.string(),
  isComposioManaged: import_v3.z.boolean(),
  toolkit: import_v3.z.string()
});
var AuthConfigRetrieveResponseSchema = import_v3.z.object({
  id: import_v3.z.string(),
  name: import_v3.z.string(),
  toolkit: import_v3.z.object({
    logo: import_v3.z.string(),
    slug: import_v3.z.string()
  }),
  noOfConnections: import_v3.z.number(),
  status: import_v3.z.enum(["ENABLED", "DISABLED"]),
  uuid: import_v3.z.string(),
  authScheme: AuthSchemeEnum.optional(),
  credentials: import_v3.z.record(import_v3.z.string(), import_v3.z.unknown()).optional(),
  expectedInputFields: import_v3.z.array(import_v3.z.unknown()).optional(),
  /**
   * @deprecated - use tool access config to determine the tools that the user can perform on the auth config.
   */
  restrictToFollowingTools: import_v3.z.array(import_v3.z.string()).optional(),
  isComposioManaged: import_v3.z.boolean().optional(),
  createdBy: import_v3.z.string().optional(),
  createdAt: import_v3.z.string().optional(),
  lastUpdatedAt: import_v3.z.string().optional(),
  toolAccessConfig: AuthConfigToolAccessConfigSchema.optional()
});
var AuthConfigListParamsSchema = import_v3.z.object({
  cursor: import_v3.z.string().optional(),
  isComposioManaged: import_v3.z.boolean().optional(),
  limit: import_v3.z.number().optional(),
  toolkit: import_v3.z.string().optional()
});
var AuthConfigListResponseSchema = import_v3.z.object({
  items: import_v3.z.array(AuthConfigRetrieveResponseSchema),
  nextCursor: import_v3.z.string().nullable(),
  totalPages: import_v3.z.number()
});
var AuthCustomConfigUpdateParamsSchema = import_v3.z.object({
  credentials: import_v3.z.record(import_v3.z.string(), import_v3.z.union([import_v3.z.string(), import_v3.z.unknown()])),
  type: import_v3.z.literal("custom"),
  /**
   * @deprecated - use tool access config to determine the tools that the user can perform on the auth config.
   */
  restrictToFollowingTools: import_v3.z.array(import_v3.z.string()).optional(),
...
var AuthDefaultConfigUpdateParamsSchema = import_v3.z.object({
  scopes: import_v3.z.string().optional(),
  type: import_v3.z.literal("default"),
  /**
   * @deprecated - use tool access config to determine the tools that the user can perform on the auth config.
   */
  restrictToFollowingTools: import_v3.z.array(import_v3.z.string()).optional(),
...
var AuthConfigUpdateParamsSchema = import_v3.z.discriminatedUnion("type", [
...
var RedirectableAuthSchemeSchema = import_v32.z.enum([
  AuthSchemeTypes.OAUTH1,
  AuthSchemeTypes.OAUTH2
]);
var BaseSchemeRaw = import_v32.z.object({
  // for posthog, freshdesk, zendesk, clickup and others
  subdomain: import_v32.z.string().optional(),
  // for atlassian
  ["your-domain"]: import_v32.z.string().optional(),
  // for mixpanel
  region: import_v32.z.string().optional(),
  // for shopify
  shop: import_v32.z.string().optional(),
  // for snowflake
  account_url: import_v32.z.string().optional(),
  // likely pipedrive
  COMPANYDOMAIN: import_v32.z.string().optional(),
  // likely zoho
  extension: import_v32.z.string().optional(),
  // likely formsite
  form_api_base_url: import_v32.z.string().optional(),
  // likely salesforce
  instanceEndpoint: import_v32.z.string().optional(),
  // likely active campaign
  api_url: import_v32.z.string().optional(),
  // for borneo
  borneo_dashboard_url: import_v32.z.string().optional(),
  // for zenrows proxy
  proxy_username: import_v32.z.string().optional(),
  proxy_password: import_v32.z.string().optional(),
  // for d2l
  domain: import_v32.z.string().optional(),
  version: import_v32.z.string().optional(),
  // for mailchimp
  dc: import_v32.z.string().optional(),
  // for sharepoint
  site_name: import_v32.z.string().optional(),
  // for servicenow
  instanceName: import_v32.z.string().optional(),
  // for netsuite
  account_id: import_v32.z.string().optional(),
  // for custom servers
  your_server: import_v32.z.string().optional(),
  // for ragic
  server_location: import_v32.z.string().optional(),
  // base_url only
  base_url: import_v32.z.string().optional(),
  // for api key
  api_key: import_v32.z.string().optional(),
  // for generic api key
  generic_api_key: import_v32.z.string().optional(),
  // for bearer token
  bearer_token: import_v32.z.string().optional()
}).catchall(import_v32.z.unknown());
var Oauth2InitiatingConnectionDataSchema = BaseSchemeRaw.extend({
  status: import_v32.z.literal(ConnectionStatuses.INITIALIZING)
}).catchall(import_v32.z.unknown());
var Oauth2InitiatedConnectionDataSchema = Oauth2InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.INITIATED),
  code_verifier: import_v32.z.string().optional(),
  redirectUrl: import_v32.z.string(),
  callback_url: import_v32.z.string().optional(),
  finalRedirectUri: import_v32.z.string().optional(),
  // previously verification_token, will be sent as verification_token to slack
  webhook_signature: import_v32.z.string().optional()
}).catchall(import_v32.z.unknown());
var Oauth2ActiveConnectionDataSchema = Oauth2InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.ACTIVE),
  access_token: import_v32.z.string().optional(),
  id_token: import_v32.z.string().optional(),
  token_type: import_v32.z.string().optional(),
  refresh_token: import_v32.z.string().nullish(),
  expires_in: import_v32.z.union([import_v32.z.string(), import_v32.z.number(), import_v32.z.null()]).optional(),
  scope: import_v32.z.union([import_v32.z.string(), import_v32.z.array(import_v32.z.string()), import_v32.z.null()]).optional(),
  // previously verification_token, will be sent as verification_token to slack
  webhook_signature: import_v32.z.string().optional(),
  authed_user: import_v32.z.object({
    access_token: import_v32.z.string().optional(),
    scope: import_v32.z.string().optional()
  }).optional().describe("for slack user scopes")
}).catchall(import_v32.z.unknown());
var Oauth2FailedConnectionDataSchema = Oauth2InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.FAILED),
  error: import_v32.z.string().optional(),
  error_description: import_v32.z.string().optional()
}).catchall(import_v32.z.unknown());
var Oauth2ExpiredConnectionDataSchema = Oauth2InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.EXPIRED),
  expired_at: import_v32.z.string().optional()
}).catchall(import_v32.z.unknown());
var Oauth2InactiveConnectionDataSchema = Oauth2InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.INACTIVE)
}).catchall(import_v32.z.unknown());
var Oauth2ConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var CustomOauth2ConnectionDataSchema = Oauth2ActiveConnectionDataSchema.omit({
  ...
  access_token: import_v32.z.string()
});
...
var Oauth1InitiatedConnectionDataSchema = Oauth1InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.INITIATED),
  oauth_token: import_v32.z.string().optional(),
  authUri: import_v32.z.string().optional(),
  oauth_token_secret: import_v32.z.string().optional(),
  redirectUrl: import_v32.z.string().optional(),
  callbackUrl: import_v32.z.string().optional()
}).catchall(import_v32.z.unknown());
var Oauth1ActiveConnectionDataSchema = Oauth1InitiatingConnectionDataSchema.extend({
  status: import_v32.z.literal(ConnectionStatuses.ACTIVE),
  oauth_token: import_v32.z.string().optional(),
  consumer_key: import_v32.z.string().optional(),
  redirectUrl: import_v32.z.string().optional(),
  callback_url: import_v32.z.string().optional()
}).catchall(import_v32.z.unknown());
...
var Oauth1ConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var CustomOauth1ConnectionDataSchema = Oauth1ActiveConnectionDataSchema.omit({
  ...
  oauth_token_secret: import_v32.z.string(),
  oauth_token: import_v32.z.string()
});
var BillcomAuthInitiatingSchema = BaseSchemeRaw.extend({
  status: import_v32.z.literal(ConnectionStatuses.INITIALIZING)
}).catchall(import_v32.z.unknown());
var BillcomAuthConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
  ...
  BillcomAuthInitiatingSchema.extend({
    status: import_v32.z.literal(ConnectionStatuses.ACTIVE),
    sessionId: import_v32.z.string(),
    devKey: import_v32.z.string()
  }).catchall(import_v32.z.unknown()),
  BillcomAuthInitiatingSchema.extend({
    status: import_v32.z.literal(ConnectionStatuses.FAILED),
    error: import_v32.z.string().optional(),
...
var BasicInitiatingSchema = BaseSchemeRaw.extend({
  status: import_v32.z.literal(ConnectionStatuses.ACTIVE),
  username: import_v32.z.string(),
  password: import_v32.z.string()
}).catchall(import_v32.z.unknown());
var BasicConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var ApiKeyConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var BearerTokenInitiatingSchema = BaseSchemeRaw.extend({
  status: import_v32.z.literal(ConnectionStatuses.ACTIVE),
  token: import_v32.z.string()
}).catchall(import_v32.z.unknown());
var BearerTokenConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var GoogleServiceAccountInitiatingSchema = BaseSchemeRaw.extend({
  status: import_v32.z.literal(ConnectionStatuses.ACTIVE),
  credentials_json: import_v32.z.string()
}).catchall(import_v32.z.unknown());
var GoogleServiceAccountConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var NoAuthConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var CalcomAuthConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var BasicWithJwtConnectionDataSchema = import_v32.z.discriminatedUnion("status", [
...
var ConnectionDataSchema = import_v32.z.discriminatedUnion("authScheme", [
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.OAUTH1),
    /**
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.OAUTH2),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.API_KEY),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.BASIC),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.BEARER_TOKEN),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.GOOGLE_SERVICE_ACCOUNT),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.NO_AUTH),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.CALCOM_AUTH),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  // }),
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.BILLCOM_AUTH),
    /**
     * the main connection data discriminated by auth scheme
     */
  ...
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.BASIC_WITH_JWT),
    /**
     * the main connection data discriminated by auth scheme
     */
...
var CustomConnectionDataSchema = import_v32.z.discriminatedUnion("authScheme", [
  import_v32.z.object({
    authScheme: import_v32.z.literal(AuthSchemeTypes.OAUTH2),
    toolkitSlug: import_v32.z.string(),
...
// src/types/tool.types.ts
var ToolkitSchema = import_v33.z.object({
  slug: import_v33.z.string().describe("The slug of the toolkit"),
  name: import_v33.z.string().describe("The name of the toolkit"),
  logo: import_v33.z.string().describe("The logo of the toolkit").optional()
});
var JSONSchemaType = import_v33.z.enum([
  "string",
  "number",
  "integer",
  "boolean",
...
var JSONSchemaPropertySchema = import_v33.z.object({
  type: import_v33.z.union([JSONSchemaType, import_v33.z.array(JSONSchemaType)]).optional(),
  description: import_v33.z.string().optional(),
  anyOf: import_v33.z.lazy(() => import_v33.z.array(JSONSchemaPropertySchema)).optional(),
  oneOf: import_v33.z.lazy(() => import_v33.z.array(JSONSchemaPropertySchema)).optional(),
  allOf: import_v33.z.lazy(() => import_v33.z.array(JSONSchemaPropertySchema)).optional(),
  not: import_v33.z.lazy(() => JSONSchemaPropertySchema).optional(),
  title: import_v33.z.string().optional(),
  default: import_v33.z.any().optional(),
  nullable: import_v33.z.boolean().optional(),
  properties: import_v33.z.lazy(() => import_v33.z.record(import_v33.z.string(), JSONSchemaPropertySchema)).optional(),
  required: import_v33.z.array(import_v33.z.string()).optional(),
  file_uploadable: import_v33.z.boolean().optional(),
  file_downloadable: import_v33.z.boolean().optional(),
  items: import_v33.z.lazy(() => import_v33.z.union([JSONSchemaPropertySchema, import_v33.z.array(JSONSchemaPropertySchema)])).optional(),
  enum: import_v33.z.array(import_v33.z.any()).optional(),
  const: import_v33.z.any().optional(),
  minimum: import_v33.z.number().optional(),
  maximum: import_v33.z.number().optional(),
  exclusiveMinimum: import_v33.z.number().optional(),
  exclusiveMaximum: import_v33.z.number().optional(),
  multipleOf: import_v33.z.number().optional(),
  minLength: import_v33.z.number().optional(),
  maxLength: import_v33.z.number().optional(),
  pattern: import_v33.z.string().optional(),
  format: import_v33.z.string().optional(),
  minItems: import_v33.z.number().optional(),
  maxItems: import_v33.z.number().optional(),
  uniqueItems: import_v33.z.boolean().optional(),
  minProperties: import_v33.z.number().optional(),
  maxProperties: import_v33.z.number().optional(),
  patternProperties: import_v33.z.lazy(() => import_v33.z.record(import_v33.z.string(), JSONSchemaPropertySchema)).optional(),
  additionalProperties: import_v33.z.union([import_v33.z.boolean(), import_v33.z.lazy(() => JSONSchemaPropertySchema)]).optional(),
  examples: import_v33.z.array(import_v33.z.any()).optional(),
  readOnly: import_v33.z.boolean().optional(),
  writeOnly: import_v33.z.boolean().optional(),
  if: import_v33.z.lazy(() => JSONSchemaPropertySchema).optional(),
  then: import_v33.z.lazy(() => JSONSchemaPropertySchema).optional(),
  else: import_v33.z.lazy(() => JSONSchemaPropertySchema).optional(),
  $ref: import_v33.z.string().optional(),
  definitions: import_v33.z.record(
    import_v33.z.string(),
    import_v33.z.lazy(() => JSONSchemaPropertySchema)
  ).optional(),
  $defs: import_v33.z.record(
    import_v33.z.string(),
    import_v33.z.lazy(() => JSONSchemaPropertySchema)
  ).optional()
});
var ParametersSchema = import_v33.z.object({
  type: import_v33.z.literal("object"),
  anyOf: import_v33.z.array(JSONSchemaPropertySchema).optional(),
  oneOf: import_v33.z.array(JSONSchemaPropertySchema).optional(),
  allOf: import_v33.z.array(JSONSchemaPropertySchema).optional(),
  not: JSONSchemaPropertySchema.optional(),
  properties: import_v33.z.record(import_v33.z.string(), JSONSchemaPropertySchema),
  required: import_v33.z.array(import_v33.z.string()).optional(),
  title: import_v33.z.string().optional(),
  default: import_v33.z.any().optional(),
  nullable: import_v33.z.boolean().optional(),
  description: import_v33.z.string().optional(),
  additionalProperties: import_v33.z.boolean().default(false).optional()
});
var ToolSchema = import_v33.z.object({
  slug: import_v33.z.string().describe('The slug of the tool. eg. "GOOGLE_SEARCH"'),
  name: import_v33.z.string().describe(`The name of the tool. eg. "Google Search"`),
  description: import_v33.z.string().optional().describe("The description of the tool"),
  ...
  tags: import_v33.z.array(import_v33.z.string()).describe("The tags of the tool. eg: Important").default([]).optional(),
  toolkit: ToolkitSchema.describe("The toolkit of the tool").optional(),
  version: import_v33.z.string().describe('The version of the tool, e.g. "20250909_00"').optional(),
  isDeprecated: import_v33.z.boolean().describe("Whether the tool is deprecated").optional(),
  availableVersions: import_v33.z.array(import_v33.z.string()).describe("Available versions of the tool.").default([]).optional(),
  scopes: import_v33.z.array(import_v33.z.string()).describe('The scopes of the tool. eg: ["task:add"]').optional(),
  isNoAuth: import_v33.z.boolean().describe("Do the tool support no auth?").optional()
});
var ToolListResponseSchema = import_v33.z.object({
  items: import_v33.z.array(ToolSchema),
  nextCursor: import_v33.z.string().nullable().optional(),
  totalPages: import_v33.z.number()
});
var ToolListParamsSchema = import_v33.z.object({
  tools: import_v33.z.array(import_v33.z.string()).optional(),
  toolkits: import_v33.z.array(import_v33.z.string()).optional(),
  scopes: import_v33.z.array(import_v33.z.string()).optional(),
  tags: import_v33.z.array(import_v33.z.string()).optional(),
  limit: import_v33.z.number().optional(),
  search: import_v33.z.string().optional(),
  authConfigIds: import_v33.z.array(import_v33.z.string()).optional()
});
var CustomAuthParamsSchema = import_v33.z.object({
  baseURL: import_v33.z.string().optional(),
  body: import_v33.z.record(import_v33.z.string(), import_v33.z.unknown()).optional(),
  parameters: import_v33.z.array(
    import_v33.z.object({
      in: import_v33.z.enum(["query", "header"]),
      name: import_v33.z.string(),
      value: import_v33.z.union([import_v33.z.string(), import_v33.z.number()])
    })
  )
});
var ToolExecuteParamsSchema = import_v33.z.object({
  allowTracing: import_v33.z.boolean().optional(),
  connectedAccountId: import_v33.z.string().optional(),
  customAuthParams: CustomAuthParamsSchema.optional(),
  customConnectionData: CustomConnectionDataSchema.optional(),
  arguments: import_v33.z.record(import_v33.z.string(), import_v33.z.unknown()).optional(),
  userId: import_v33.z.string().optional(),
  version: import_v33.z.union([import_v33.z.literal("latest"), import_v33.z.string()]).optional(),
  dangerouslySkipVersionCheck: import_v33.z.boolean().optional(),
  text: import_v33.z.string().optional()
});
var ToolExecuteResponseSchema = import_v33.z.object({
  data: import_v33.z.record(import_v33.z.string(), import_v33.z.unknown()),
  error: import_v33.z.string().nullable(),
  successful: import_v33.z.boolean(),
  logId: import_v33.z.string().optional(),
  sessionInfo: import_v33.z.unknown().optional()
});
var ToolProxyParamsSchema = import_v33.z.object({
  endpoint: import_v33.z.string(),
  method: import_v33.z.enum(["GET", "POST", "PUT", "DELETE", "PATCH"]),
  body: import_v33.z.unknown().optional(),
  parameters: import_v33.z.array(
    import_v33.z.object({
      in: import_v33.z.enum(["query", "header"]),
      name: import_v33.z.string(),
...
${originalStackBody}`;
  ...
  static handle(error, options = {}) {
    ...
    if (error instanceof _ComposioError) {
      error.prettyPrint(includeStack);
    } else if (error instanceof import_v34.ZodError) {
...
var ERROR_CODE_HANDLERS = /* @__PURE__ */ new Map([
  [1803, (msg) => new ComposioConnectedAccountNotFoundError(msg)]
  // Add more error code handlers here as needed
]);
var handleToolExecutionError = (tool, actualError) => {
  if (actualError instanceof import_client2.APIError && actualError.error) {
...
var import_client3 = require("@composio/client");
...
var TelemetryTransport = class {
  ...
  async prepareAndSendErrorTelemetry(error, instrumentedClassName, name, args) {
    ...
    if (error instanceof import_client3.ComposioError) {
...
var ValidationError = class extends ComposioError {
  constructor(message = "Input validation failed", options = {}) {
    ...
    if (providedZodError instanceof import_v35.ZodError) {
      zodErrorInstance = providedZodError;
    } else {
      zodErrorInstance = new import_v35.ZodError([
        {
          path: [],
  ...
  generateUserFriendlyMessage() {
    if (this.cause instanceof import_v35.ZodError && this.cause.issues.length > 0) {
...
var ConnectedAccountStatusSchema = import_v36.z.enum([
...
var CreateConnectedAccountParamsSchema = import_v36.z.object({
  authConfig: import_v36.z.object({
    id: import_v36.z.string()
  }),
  connection: import_v36.z.object({
    data: import_v36.z.record(import_v36.z.string(), import_v36.z.unknown()).optional(),
    callbackUrl: import_v36.z.string().optional(),
    userId: import_v36.z.string().optional()
  })
});
var DefaultCreateConnectedAccountParamsSchema = import_v36.z.object({
  auth_config: import_v36.z.object({
    id: import_v36.z.string()
  }),
  connection: import_v36.z.object({
    state: ConnectionDataSchema.optional(),
    data: import_v36.z.record(import_v36.z.string(), import_v36.z.unknown()).optional(),
    callback_url: import_v36.z.string().optional(),
    user_id: import_v36.z.string().optional()
  })
});
var CreateConnectedAccountOptionsSchema = import_v36.z.object({
  allowMultiple: import_v36.z.boolean().optional(),
  callbackUrl: import_v36.z.string().optional(),
  config: ConnectionDataSchema.optional()
});
var CreateConnectedAccountResponseSchema = import_v36.z.object({
  id: import_v36.z.string(),
  status: ConnectedAccountStatusSchema,
  redirectUrl: import_v36.z.string().nullable()
});
var ConnectedAccountAuthConfigSchema = import_v36.z.object({
  id: import_v36.z.string(),
  isComposioManaged: import_v36.z.boolean(),
  isDisabled: import_v36.z.boolean()
});
var ConnectedAccountRetrieveResponseSchema = import_v36.z.object({
  id: import_v36.z.string(),
   ...
   * @deprecated use connectedAccount.state instead
   */
  params: import_v36.z.record(import_v36.z.string(), import_v36.z.unknown()).optional(),
  status: ConnectedAccountStatusSchema,
  statusReason: import_v36.z.string().nullable(),
  toolkit: import_v36.z.object({
    slug: import_v36.z.string()
  }),
  state: ConnectionDataSchema.optional(),
  testRequestEndpoint: import_v36.z.string().optional(),
  isDisabled: import_v36.z.boolean(),
  createdAt: import_v36.z.string(),
  updatedAt: import_v36.z.string()
});
var ConnectedAccountListParamsSchema = import_v36.z.object({
  authConfigIds: import_v36.z.array(import_v36.z.string()).nullable().optional().describe("The auth config ids of the connected accounts"),
  cursor: import_v36.z.string().nullish().describe("The cursor to paginate through the connected accounts"),
  labels: import_v36.z.array(import_v36.z.string()).nullable().optional().describe("The labels of the connected accounts"),
  limit: import_v36.z.number().nullable().optional().describe("The limit of the connected accounts to return"),
  orderBy: import_v36.z.enum(["created_at", "updated_at"]).optional().describe("The order by of the connected accounts"),
  statuses: import_v36.z.array(ConnectedAccountStatusSchema).nullable().optional().describe("The statuses of the connected accounts"),
  toolkitSlugs: import_v36.z.array(import_v36.z.string()).nullable().optional().describe("The toolkit slugs of the connected accounts"),
  userIds: import_v36.z.array(import_v36.z.string()).nullable().optional().describe("The user ids of the connected accounts")
});
var ConnectedAccountListResponseSchema = import_v36.z.object({
  items: import_v36.z.array(ConnectedAccountRetrieveResponseSchema).describe("The list of connected accounts"),
  nextCursor: import_v36.z.string().nullish().describe("The next cursor to paginate through the connected accounts"),
  totalPages: import_v36.z.number().describe("The total number of pages of connected accounts")
});
var CreateConnectedAccountLinkOptionsSchema = import_v36.z.object({
  /**
...
var CreateConnectedAccountLinkResponseSchema = import_v36.z.object({
  redirectUrl: import_v36.z.string()
});
...
var CustomTools = class {
  ...
  async createTool(toolOptions) {
    ...
    const paramsSchema = (0, import_zod_to_json_schema.default)(inputParams, {
      name: "input"
    });
...
var Tools = class {
  ...
  async executeComposioTool(tool, body) {
    ...
    try {
      ...
      const toolError = handleToolExecutionError(tool.slug, error);
      throw toolError;
    }
  }
  /**
...
var import_client5 = __toESM(require("@composio/client"), 1);

// src/types/toolkit.types.ts
var import_v37 = require("zod/v3");
var ToolkitMangedByEnumSchema = import_v37.z.enum(["all", "composio", "project"]);
var ToolkitSortByEnumSchema = import_v37.z.enum(["usage", "alphabetically"]);
var ToolkitsListParamsSchema = import_v37.z.object({
  category: import_v37.z.string().optional(),
  isLocal: import_v37.z.boolean().optional(),
  managedBy: ToolkitMangedByEnumSchema.optional(),
  sortBy: ToolkitSortByEnumSchema.optional()
});
var ToolKitMetaSchema = import_v37.z.object({
  categories: import_v37.z.array(
    import_v37.z.object({
      slug: import_v37.z.string(),
      name: import_v37.z.string()
    })
  ).optional(),
  appUrl: import_v37.z.string().optional(),
  createdAt: import_v37.z.string().optional(),
  description: import_v37.z.string().optional(),
  logo: import_v37.z.string().optional(),
  toolsCount: import_v37.z.number().optional(),
  triggersCount: import_v37.z.number().optional(),
  updatedAt: import_v37.z.string().optional(),
  availableVersions: import_v37.z.array(import_v37.z.string()).optional()
});
var ToolKitItemSchema = import_v37.z.object({
  name: import_v37.z.string(),
  slug: import_v37.z.string(),
  meta: ToolKitMetaSchema,
  isLocalToolkit: import_v37.z.boolean(),
  authSchemes: import_v37.z.array(import_v37.z.string()).optional(),
  composioManagedAuthSchemes: import_v37.z.array(import_v37.z.string()).optional(),
  noAuth: import_v37.z.boolean().optional()
});
var ToolKitListResponseSchema = import_v37.z.array(ToolKitItemSchema);
var ToolkitAuthFieldSchema = import_v37.z.object({
  description: import_v37.z.string(),
  displayName: import_v37.z.string(),
  required: import_v37.z.boolean(),
  name: import_v37.z.string(),
  type: import_v37.z.string(),
  default: import_v37.z.string().nullable().optional()
});
var ToolkitAuthConfigDetailsSchema = import_v37.z.object({
  name: import_v37.z.string(),
  mode: import_v37.z.string(),
  fields: import_v37.z.object({
    authConfigCreation: import_v37.z.object({
      optional: import_v37.z.array(ToolkitAuthFieldSchema),
      required: import_v37.z.array(ToolkitAuthFieldSchema)
    }),
    connectedAccountInitiation: import_v37.z.object({
      optional: import_v37.z.array(ToolkitAuthFieldSchema),
      required: import_v37.z.array(ToolkitAuthFieldSchema)
    })
  }),
  proxy: import_v37.z.object({
    baseUrl: import_v37.z.string().optional()
  }).optional()
});
var ToolkitRetrieveResponseSchema = import_v37.z.object({
  name: import_v37.z.string(),
  slug: import_v37.z.string(),
  meta: ToolKitMetaSchema,
  isLocalToolkit: import_v37.z.boolean(),
  composioManagedAuthSchemes: import_v37.z.array(import_v37.z.string()).optional(),
  authConfigDetails: import_v37.z.array(ToolkitAuthConfigDetailsSchema).optional(),
  baseUrl: import_v37.z.string().optional(),
  getCurrentUserEndpoint: import_v37.z.string().optional()
});
var ToolkitCategorySchema = import_v37.z.object({
  id: import_v37.z.string(),
  name: import_v37.z.string()
});
var ToolkitRetrieveCategoriesResponseSchema = import_v37.z.object({
  items: import_v37.z.array(ToolkitCategorySchema),
  nextCursor: import_v37.z.string().nullable(),
  totalPages: import_v37.z.number()
});
var ToolkitAuthFieldsResponseSchema = import_v37.z.array(
  ToolkitAuthFieldSchema.extend({
    required: import_v37.z.boolean().optional()
  })
);
...
function createConnectionRequest(client, connectedAccountId, status, redirectUrl) {
  ...
  async function waitForConnection(timeout = 6e4) {
    try {
      ...
      if (error instanceof import_client4.default.NotFoundError) {
        throw new ComposioConnectedAccountNotFoundError(
...
var transformToolkitRetrieveResponse = (response) => {
  return transform(response).with(ToolkitRetrieveResponseSchema).using((response2) => ({
    ...
    meta: {
      ...
      availableVersions: response2.meta.available_versions
    ...
    if (!authConfigIdToUse) {
      if (toolkit.authConfigDetails && toolkit.authConfigDetails.length > 0) {
        try {
          ...
          if (error instanceof import_client5.default.APIError && error.status === 400) {
            throw new ComposioAuthConfigNotFoundError(
...
var import_client7 = require("@composio/client");
...
var TriggerStatusEnum = import_v38.z.enum(["enable", "disable"]);
var TriggerSubscribeParamSchema = import_v38.z.object({
  toolkits: import_v38.z.array(import_v38.z.string()).optional(),
  triggerId: import_v38.z.string().optional(),
  connectedAccountId: import_v38.z.string().optional(),
  authConfigId: import_v38.z.string().optional(),
  triggerSlug: import_v38.z.array(import_v38.z.string()).optional(),
  triggerData: import_v38.z.string().optional(),
  userId: import_v38.z.string().optional()
});
var TriggerInstanceListActiveParamsSchema = import_v38.z.object({
  authConfigIds: import_v38.z.array(import_v38.z.string()).nullable().optional(),
  connectedAccountIds: import_v38.z.array(import_v38.z.string()).nullable().optional(),
  limit: import_v38.z.number().optional(),
  page: import_v38.z.number().optional(),
  showDisabled: import_v38.z.boolean().nullable().optional(),
  triggerIds: import_v38.z.array(import_v38.z.string()).nullable().optional(),
  triggerNames: import_v38.z.array(import_v38.z.string()).nullable().optional()
});
var TriggerInstanceListActiveResponseItemSchema = import_v38.z.object({
  id: import_v38.z.string(),
  connectedAccountId: import_v38.z.string(),
  disabledAt: import_v38.z.string().nullable(),
  state: import_v38.z.record(import_v38.z.unknown()),
  triggerConfig: import_v38.z.record(import_v38.z.unknown()),
  triggerName: import_v38.z.string(),
  updatedAt: import_v38.z.string(),
  triggerData: import_v38.z.string().optional(),
  uuid: import_v38.z.string().optional()
});
var TriggerInstanceListActiveResponseSchema = import_v38.z.object({
  items: import_v38.z.array(TriggerInstanceListActiveResponseItemSchema),
  nextCursor: import_v38.z.string().nullable(),
  totalPages: import_v38.z.number()
});
var TriggerInstanceUpsertParamsSchema = import_v38.z.object({
  connectedAccountId: import_v38.z.string().optional(),
  triggerConfig: import_v38.z.record(import_v38.z.unknown()).optional()
});
var TriggerInstanceUpsertResponseSchema = import_v38.z.object({
  triggerId: import_v38.z.string()
});
var TriggerInstanceManageUpdateParamsSchema = import_v38.z.object({
  status: import_v38.z.enum(["enable", "disable"])
});
var TriggerInstanceManageUpdateResponseSchema = import_v38.z.object({
  status: import_v38.z.enum(["success"])
});
var TriggerInstanceManageDeleteResponseSchema = import_v38.z.object({
  triggerId: import_v38.z.string()
});
var IncomingTriggerPayloadSchema = import_v38.z.object({
  id: import_v38.z.string().describe("The ID of the trigger"),
  uuid: import_v38.z.string().describe("The UUID of the trigger"),
  triggerSlug: import_v38.z.string().describe("The slug of the trigger that triggered the event"),
  toolkitSlug: import_v38.z.string().describe("The slug of the toolkit that triggered the event"),
  userId: import_v38.z.string().describe("The ID of the user that triggered the event"),
  payload: import_v38.z.record(import_v38.z.unknown()).describe("The payload of the trigger").optional(),
  originalPayload: import_v38.z.record(import_v38.z.unknown()).describe("The original payload of the trigger").optional(),
  metadata: import_v38.z.object({
    id: import_v38.z.string(),
    uuid: import_v38.z.string(),
    toolkitSlug: import_v38.z.string(),
    triggerSlug: import_v38.z.string(),
    triggerData: import_v38.z.string().optional(),
    triggerConfig: import_v38.z.record(import_v38.z.unknown()),
    connectedAccount: import_v38.z.object({
      id: import_v38.z.string(),
      uuid: import_v38.z.string(),
      authConfigId: import_v38.z.string(),
      authConfigUUID: import_v38.z.string(),
      userId: import_v38.z.string(),
      status: import_v38.z.enum(["ACTIVE", "INACTIVE"])
    })
  })
});
var TriggersTypeListParamsSchema = import_v38.z.object({
  cursor: import_v38.z.string().optional(),
  limit: import_v38.z.number().nullish(),
  toolkits: import_v38.z.array(import_v38.z.string()).nullish()
});
var TriggerTypeSchema = import_v38.z.object({
  slug: import_v38.z.string(),
  name: import_v38.z.string(),
  description: import_v38.z.string(),
  instructions: import_v38.z.string().optional(),
  toolkit: import_v38.z.object({
    logo: import_v38.z.string(),
    slug: import_v38.z.string(),
    name: import_v38.z.string()
  }),
  payload: import_v38.z.record(import_v38.z.unknown()),
  config: import_v38.z.record(import_v38.z.unknown()),
  version: import_v38.z.string().optional()
});
var TriggersTypeListResponseSchema = import_v38.z.object({
  items: import_v38.z.array(TriggerTypeSchema),
  nextCursor: import_v38.z.string().nullish(),
  totalPages: import_v38.z.number()
});

// src/services/internal/InternalService.types.ts
var import_v39 = require("zod/v3");
var SDKRealtimeCredentialsResponseSchema = import_v39.z.object({
  projectId: import_v39.z.string().describe("The project ID"),
  pusherKey: import_v39.z.string().describe("The Pusher key"),
  pusherCluster: import_v39.z.string().describe("The Pusher cluster")
});
...
var ComposioFailedToGetSDKRealtimeCredentialsError = class extends import_client6.ComposioError {
...
var ComposioFailedToCreatePusherClientError = class extends import_client6.ComposioError {
...
var ComposioFailedToSubscribeToPusherChannelError = class extends import_client6.ComposioError {
...
var ComposioTriggerTypeNotFoundError = class extends import_client6.ComposioError {
...
var Triggers = class {
  ...
  async create(userId, slug, body) {
    ...
    try {
      ...
      if (error instanceof import_client7.APIError && (error.status === 400 || error.status === 404)) {
    ...
    try {
      ...
      if (error instanceof import_client7.APIError && [400, 404].includes(error.status)) {
        throw new ComposioConnectedAccountNotFoundError(
          `No connected account found for user ${userId} for toolkit ${toolkitSlug}`,
          {
            cause: error,
...
var import_v310 = __toESM(require("zod/v3"), 1);
var MCPServerInstanceSchema = import_v310.default.object({
  id: import_v310.default.string(),
  name: import_v310.default.string(),
  type: import_v310.default.literal("streamable_http"),
  url: import_v310.default.string(),
  userId: import_v310.default.string(),
  allowedTools: import_v310.default.array(import_v310.default.string()),
  authConfigs: import_v310.default.array(import_v310.default.string())
});
var MCPConfigToolkitsSchema = import_v310.default.object({
  toolkit: import_v310.default.string().describe("Id of the toolkit").optional(),
  authConfigId: import_v310.default.string().describe("Id of the auth config").optional()
});
var MCPConfigCreationParamsSchema = import_v310.default.object({
  toolkits: import_v310.default.array(import_v310.default.union([MCPConfigToolkitsSchema, import_v310.default.string()])),
  allowedTools: import_v310.default.array(import_v310.default.string()).optional(),
  manuallyManageConnections: import_v310.default.boolean().default(false).optional().describe(
...
var MCPConfigResponseSchema = import_v310.default.object({
  /**
...
var MCPListParamsSchema = import_v310.default.object({
  page: import_v310.default.number().optional().default(1),
  limit: import_v310.default.number().optional().default(10),
  toolkits: import_v310.default.array(import_v310.default.string()).optional().default([]),
  authConfigs: import_v310.default.array(import_v310.default.string()).optional().default([]),
  name: import_v310.default.string().optional()
});
var MCPItemSchema = MCPConfigResponseSchema.extend({
  ...import_v310.default.object({
    toolkitIcons: import_v310.default.record(import_v310.default.string(), import_v310.default.string()),
    serverInstanceCount: import_v310.default.number(),
    toolkits: import_v310.default.array(import_v310.default.string())
  }).shape
});
var MCPListResponseSchema = import_v310.default.object({
  items: import_v310.default.array(MCPItemSchema),
  currentPage: import_v310.default.number(),
  totalPages: import_v310.default.number()
});
var MCPUpdateParamsSchema = import_v310.default.object({
  name: import_v310.default.string().optional(),
  toolkits: import_v310.default.array(import_v310.default.union([MCPConfigToolkitsSchema, import_v310.default.string()])).optional(),
  allowedTools: import_v310.default.array(import_v310.default.string()).optional(),
  manuallyManageConnections: import_v310.default.boolean().optional().describe(
    `Whether to manually manage accounts. If true, you need to manage accounts manually connect user accounts. 
If set to false, composio will inject account maangement tools into your mcp server for agents to request and authenticate accounts.
defaults to false`
  )
});
var MCPServerConnectionStatus = import_v310.default.object({
  connected: import_v310.default.boolean(),
  toolkit: import_v310.default.string(),
  connectedAccountId: import_v310.default.string()
});
var MCPServerConnectedAccountsSchema = import_v310.default.record(
  import_v310.default.string(),
  import_v310.default.array(
    import_v310.default.object({
      toolkit: import_v310.default.string(),
      authConfigId: import_v310.default.string(),
      connectedAccountId: import_v310.default.string()
    })
  )
);
...
var MCPToolkitConfigSchema = import_v311.z.object({
  toolkit: import_v311.z.string().min(1, "Toolkit name cannot be empty"),
  authConfigId: import_v311.z.string().min(1, "Auth config ID cannot be empty"),
  allowedTools: import_v311.z.array(import_v311.z.string().min(1, "Tool name cannot be empty")).min(1, "At least one tool must be specified")
});
var MCPToolkitConfigsArraySchema = import_v311.z.array(MCPToolkitConfigSchema).min(1, "At least one toolkit configuration is required").refine((configs) => {
...
var MCPAuthOptionsSchema = import_v311.z.object({
  isChatAuth: import_v311.z.boolean().optional()
});
var MCPGetServerParamsSchema = import_v311.z.object({
  userId: import_v311.z.string().min(1, "User ID cannot be empty").optional(),
  connectedAccountIds: import_v311.z.record(import_v311.z.string(), import_v311.z.string().min(1, "Account ID cannot be empty")).optional()
}).refine(
  (data) => {
...
var MCPGenerateURLParamsSchema = import_v311.z.object({
  userIds: import_v311.z.array(import_v311.z.string()).optional(),
  connectedAccountIds: import_v311.z.array(import_v311.z.string()).optional(),
  isChatAuth: import_v311.z.boolean().optional()
});
var ComposioGenerateURLParamsSchema = import_v311.z.object({
  user_ids: import_v311.z.array(import_v311.z.string()).optional(),
  connected_account_ids: import_v311.z.array(import_v311.z.string()).optional(),
  mcp_server_id: import_v311.z.string(),
  managed_auth_by_composio: import_v311.z.boolean().optional()
});
var GenerateURLParamsSchema = import_v311.z.object({
  userIds: import_v311.z.array(import_v311.z.string()).optional(),
  connectedAccountIds: import_v311.z.array(import_v311.z.string()).optional(),
  mcpServerId: import_v311.z.string(),
  composioManagedAuth: import_v311.z.boolean().optional()
});
var GenerateURLResponseSchema = import_v311.z.object({
  connectedAccountUrls: import_v311.z.array(import_v311.z.string()).optional(),
  userIdsUrl: import_v311.z.array(import_v311.z.string()).optional(),
  mcpUrl: import_v311.z.string().min(1, "MCP URL cannot be empty")
});
var ComposioGenerateURLResponseSchema = import_v311.z.object({
  connected_account_urls: import_v311.z.array(import_v311.z.string()).optional(),
  user_ids_url: import_v311.z.array(import_v311.z.string()).optional(),
  mcp_url: import_v311.z.string().min(1, "MCP URL cannot be empty")
});
var MCPSingleAppServerSchema = import_v311.z.object({
  name: import_v311.z.string().describe("Name of the MCP server"),
  tools: import_v311.z.array(import_v311.z.string()).describe("List of allowed tools"),
  authConfigId: import_v311.z.string().optional().describe("Auth config ID for the server")
});
var MCPMultiAppServerSchema = import_v311.z.object({
  name: import_v311.z.string().describe("Name of the MCP server"),
  tools: import_v311.z.array(import_v311.z.string()).describe("List of allowed tools across toolkits"),
  toolkits: import_v311.z.array(import_v311.z.string()).describe("List of allowed toolkits")
});
var MCPServerSchema = import_v311.z.object({
  id: import_v311.z.string().describe("Unique identifier for the MCP server"),
  type: import_v311.z.enum(["single", "multi"]).describe("Type of MCP server"),
  createdAt: import_v311.z.string().describe("Creation timestamp"),
  updatedAt: import_v311.z.string().describe("Last update timestamp"),
  status: import_v311.z.enum(["active", "inactive", "error"]).default("active"),
  config: import_v311.z.union([MCPSingleAppServerSchema, MCPMultiAppServerSchema])
});
var MCPServerListResponseSchema = import_v311.z.object({
  items: import_v311.z.array(MCPServerSchema),
  total: import_v311.z.number(),
  page: import_v311.z.number(),
  pageSize: import_v311.z.number()
});
var MCPServerUpdateParamsSchema = import_v311.z.object({
  name: import_v311.z.string().optional().describe("New name for the server"),
  toolkits: import_v311.z.array(import_v311.z.string()).optional().describe("Updated list of toolkits"),
  allowedTools: import_v311.z.array(import_v311.z.string()).optional().describe("Updated list of allowed tools")
});
...
var CustomCreateResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  name: import_v311.z.string().min(1, "Server name cannot be empty"),
  createdAt: import_v311.z.string().nullish(),
  updatedAt: import_v311.z.string().nullish(),
  status: import_v311.z.string().nullish()
});
var ComposioCustomCreateResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  name: import_v311.z.string().min(1, "Server name cannot be empty"),
  created_at: import_v311.z.string().nullish(),
  updated_at: import_v311.z.string().nullish(),
  status: import_v311.z.string().nullish()
});
var McpListResponseSchema = import_v311.z.object({
  items: import_v311.z.array(
    import_v311.z.object({
      id: import_v311.z.string().min(1, "Server ID cannot be empty"),
      name: import_v311.z.string().min(1, "Server name cannot be empty"),
      createdAt: import_v311.z.string().optional(),
      updatedAt: import_v311.z.string().optional(),
      status: import_v311.z.string().optional()
    })
  ).optional()
});
var ComposioMcpListResponseSchema = import_v311.z.object({
  items: import_v311.z.array(
    import_v311.z.object({
      id: import_v311.z.string().min(1, "Server ID cannot be empty"),
      name: import_v311.z.string().min(1, "Server name cannot be empty"),
      created_at: import_v311.z.string().optional(),
      updated_at: import_v311.z.string().optional(),
      status: import_v311.z.string().optional()
    })
  ).optional()
});
var McpRetrieveResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  name: import_v311.z.string().min(1, "Server name cannot be empty"),
  createdAt: import_v311.z.string().optional(),
  updatedAt: import_v311.z.string().optional(),
  status: import_v311.z.string().optional(),
  toolkits: import_v311.z.array(import_v311.z.string()).optional(),
  tools: import_v311.z.array(import_v311.z.string()).optional(),
  managedAuthViaComposio: import_v311.z.boolean().optional(),
  authConfigIds: import_v311.z.array(import_v311.z.string()).optional(),
  mcpUrl: import_v311.z.string(),
  commands: import_v311.z.object({
    claude: import_v311.z.string(),
    cursor: import_v311.z.string(),
    windsurf: import_v311.z.string()
  })
});
var ComposioMcpRetrieveResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  name: import_v311.z.string().min(1, "Server name cannot be empty"),
  created_at: import_v311.z.string().optional(),
  updated_at: import_v311.z.string().optional(),
  ...
  toolkits: import_v311.z.array(import_v311.z.string()).optional(),
  tools: import_v311.z.array(import_v311.z.string()).optional(),
  managed_auth_via_composio: import_v311.z.boolean().optional()
});
var McpDeleteResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  deleted: import_v311.z.boolean().optional(),
  message: import_v311.z.string().optional()
});
var ComposioMcpDeleteResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  deleted: import_v311.z.boolean().optional(),
  message: import_v311.z.string().optional()
});
var McpUpdateResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  name: import_v311.z.string().min(1, "Server name cannot be empty"),
  createdAt: import_v311.z.string().optional(),
  updatedAt: import_v311.z.string().optional(),
...
var ComposioMcpUpdateResponseSchema = import_v311.z.object({
  id: import_v311.z.string().min(1, "Server ID cannot be empty"),
  name: import_v311.z.string().min(1, "Server name cannot be empty"),
  created_at: import_v311.z.string().optional(),
  updated_at: import_v311.z.string().optional(),
...
function detectRuntime() {
  ...
  if ("caches" in global && typeof global.caches !== "undefined" && "WebSocketPair" in global && typeof global.WebSocketPair !== "undefined") {
  ...
  if ("WorkerGlobalScope" in global && typeof global.WorkerGlobalScope !== "undefined" && "importScripts" in global && typeof global.importScripts === "function") {
    return "WEB_WORKER";
  }
...
var import_v312 = __toESM(require("zod/v3"), 1);
var ToolRouterToolkitConfigSchema = import_v312.default.object({
  toolkit: import_v312.default.string(),
  authConfigId: import_v312.default.string().optional()
});
var ToolRouterConfigSchema = import_v312.default.object({
  toolkits: import_v312.default.array(import_v312.default.union([import_v312.default.string(), ToolRouterToolkitConfigSchema])).optional(),
  manuallyManageConnections: import_v312.default.boolean().optional()
});
var ToolRouterSessionSchema = import_v312.default.object({
  sessionId: import_v312.default.string(),
  url: import_v312.default.string()
});
...
var Composio = class _Composio {
  ...
  constructor(config) {
    ...
    this.client = new import_client8.default({
      apiKey: apiKeyParsed,
      baseURL: baseURLParsed,
      defaultHeaders,
