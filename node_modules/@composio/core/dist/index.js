...
var ToolSchema = z3.object({
  ...
  isDeprecated: z3.boolean().describe("Whether the tool is deprecated").optional(),
  ...
  isNoAuth: z3.boolean().describe("Do the tool support no auth?").optional()
});
...
var ToolExecuteParamsSchema = z3.object({
  ...
  dangerouslySkipVersionCheck: z3.boolean().optional(),
...
var CustomTools = class {
  ...
  async createTool(toolOptions) {
    ...
    const paramsSchema = zodToJsonSchema(inputParams, {
      name: "input"
    });
...
var ToolKitMetaSchema = z5.object({
  ...
  availableVersions: z5.array(z5.string()).optional()
});
...
var Toolkits = class {
  ...
  async getToolkitBySlug(slug) {
    try {
      ...
      if (error instanceof APIError2 && (error.status === 404 || error.status === 400)) {
...
import { APIError as APIError3 } from "@composio/client";
...
var Triggers = class {
  ...
  async create(userId, slug, body) {
    ...
    try {
      ...
      if (error instanceof APIError3 && (error.status === 400 || error.status === 404)) {
    ...
    try {
      ...
      if (error instanceof APIError3 && [400, 404].includes(error.status)) {
        throw new ComposioConnectedAccountNotFoundError(
          `No connected account found for user ${userId} for toolkit ${toolkitSlug}`,
          {
            cause: error,
