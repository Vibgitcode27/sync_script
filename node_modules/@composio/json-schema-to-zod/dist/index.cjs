...
function parseObject(objectSchema, refs) {
  ...
  const normalizedSchema = objectSchema.type === "object" ? objectSchema : { ...objectSchema, type: "object" };
...
var addDefaults = (jsonSchema, zodSchema, refs) => {
  if (jsonSchema.default !== void 0) {
    if (jsonSchema.default === null) {
      ...
      if (inAnyOfOrOneOf && jsonSchema.type && jsonSchema.type !== "null" && // @ts-ignore: `nullable` is not publicly available in Zod 4
      !jsonSchema.nullable) {
        return zodSchema;
      }
    }
